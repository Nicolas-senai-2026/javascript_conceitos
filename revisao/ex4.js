...
for (let i = 0; i < 4; i++) {
    const material = {
        nome: entrada.question(`Digite o nome do ${i + 1}o material: `), quantidade: entrada.questionInt(`Digite a quantidade do ${i + 1}o material: `), estoqueMinimo: entrada.questionInt(`Digite o estoque minimo: `)
    };
